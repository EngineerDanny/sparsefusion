...
\textbf{Data availability} The real-data benchmark inputs are stored as processed grouped-regression files in the accompanying repository at \url{https://github.com/EngineerDanny/fuserplus}. The synthetic benchmark inputs are generated from the regime manifests included in the repository.
